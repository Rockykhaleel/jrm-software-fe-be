...
dotenv.config();
const Darul = require("../models/competions_model");
const ObjectId = require("mongodb").ObjectId;
const CsvParser = require("json2csv").Parser;

module.exports = {
  addcompetions: async (req, res) => {
    const {
      tyocompetion,
      dateorganized,
      nospasticipated,
  ...
  //id
  updatecompetions: async (req, res) => {
    const { id } = req.params;
    try {
  ...
  //id
  deletecompetions: async (req, res) => {
    const { id } = req.params;
    // console.log(id);
    try {
  ...
  getAllcompetions: async (req, res) => {
    try {
  ...
  //Get User By Its Id
  //userId
  competionsByUserID: async (req, res) => {
    const { id } = req.params;
    try {
  ...
  updateOrCreatecompetions: async (req, res) => {

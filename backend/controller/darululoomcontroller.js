...
module.exports = {
  ...
  //id
  updatedarululoom: async (req, res) => {
    const { id } = req.params;
    try {
  ...
  //id
  deletedarululoom: async (req, res) => {
    const { id } = req.params;
    // console.log(id);
    try {
  ...
  getAlldarululoom: async (req, res) => {
    try {
  ...
  //Get User By Its Id
  //userId
  darululoomByUserID: async (req, res) => {
    const { id } = req.params;
    try {
  ...
  updateOrCreatedarululoom: async (req, res) => {
